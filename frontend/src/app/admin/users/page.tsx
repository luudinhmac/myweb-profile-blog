    ...
    <div className="flex min-h-screen bg-slate-50 dark:bg-slate-950">
        ...
        <div className="p-4 md:p-6 lg:p-8 max-w-[1400px] mx-auto">
          ...
          <header className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-4">
              <button onClick={() => setSidebarOpen(true)} className="md:hidden p-2 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                <Menu size={18} />
              </button>
              <div>
                <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-0.5">Người dùng</h1>
                <p className="text-[13px] text-slate-500">Quản lý tài khoản và phân quyền.</p>
              </div>
            </div>
            <button onClick={() => setShowCreateForm(true)} className="px-4 py-2 bg-primary text-white rounded-xl text-[13px] font-bold shadow-lg shadow-primary/30 hover:-translate-y-0.5 transition-all flex items-center">
                    ...
                    <tr key={u.id} className="group hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <select
                          ...
                          className={cn(
                            "px-3 py-1.5 rounded-xl text-[10px] font-bold outline-none transition-all cursor-pointer",
      ...
      {showCreateForm && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg bg-white dark:bg-slate-950 rounded-[2.5rem] p-8 shadow-2xl overflow-hidden">
            ...
            {createError && <div className="p-4 bg-red-50 text-red-500 rounded-2xl text-sm mb-6 text-center">{createError}</div>}
            <form onSubmit={handleCreate} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-slate-400 uppercase mb-2 ml-1">Username</label>
                  <input required placeholder="mac.ld" className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl text-sm"
                ...
                <div>
                  ...
                  <input required placeholder="Lưu Đình Mác" className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl text-sm"
              ...
              <div>
                ...
                <input required type="email" placeholder="mac@example.com" className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl text-sm"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input required type="password" placeholder="••••••••" className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl text-sm"
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl text-sm appearance-none"
              ...
              <button disabled={createLoading} className="w-full py-4 bg-primary text-white rounded-2xl font-bold shadow-xl shadow-primary/30 hover:opacity-90 transition-all flex items-center justify-center">
      ...
      {resetModal.open && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md bg-white dark:bg-slate-950 rounded-[2.5rem] p-8 shadow-2xl">
            ...
            {resetMsg && (
              <div className={cn("p-4 rounded-2xl text-sm mb-6 flex items-center space-x-2",
            ...
            <form onSubmit={handleResetPassword} className="space-y-4">
              <div className="relative">
                <input required type={showNewPass ? 'text' : 'password'} placeholder="Mật khẩu mới..."
                  className="w-full px-4 py-3 pr-12 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl text-sm outline-none focus:ring-2 focus:ring-primary"
              ...
              <button disabled={resetLoading} className="w-full py-4 bg-primary text-white rounded-2xl font-bold shadow-xl shadow-primary/30 flex items-center justify-center">
