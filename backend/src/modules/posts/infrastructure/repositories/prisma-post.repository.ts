...
import { IPostRepository, PostFilter, PaginationParams, PaginatedResult } from '../../domain/repositories/post.repository.interface';
...
export class PrismaPostRepository implements IPostRepository {
  ...
  async create(authorId: number, data: any): Promise<PostEntity> {
  ...
  async update(id: number, data: any): Promise<PostEntity> {
    const { tags, series_name, series_id, category_id, ...postData } = data;
